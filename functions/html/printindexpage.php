    ...
    if($previousCorp != 'None') {
        printf("<div class=\"blocks\">");
            printf("<div class=\"container\">");
              ...
              printf("<div class=\"view view-first\"> <a href=\"wgas.php?corporation=$previousCorp\"><img src=\"https://image.eveonline.com/Type/30375_64.png\" /></div>");
              printf("<div class=\"clearfix\"></div>");
              printf("<h3 class=\"page-header\"> Salvage Materials <strong>(COMING SOON)</strong></h3>");
              printf("<div class=\"view view-first\"><img src=\"https://image.eveonline.com/Type/25605_64.png\" /></a> </div>");
              printf("<div class=\"view view-first\"><img src=\"https://image.eveonline.com/Type/30024_64.png\" /></div>");
              printf("<div class=\"clearfix\"></div>");
            printf("</div>");
          printf("</div>");
        ...
        printf("<div class=\"blocks\">");
            printf("<div class=\"container\">");
              ...
              printf("<h3 class=\"page-header\"> Gas Cloud Materials <strong>(2nd Icon Works)</strong></h3>");
              printf("<div class=\"view view-first\"> <img src=\"https://image.eveonline.com/Type/25268_64.png\" /></div>");
              printf("<div class=\"view view-first\"> <a href=\"wgas.php\"><img src=\"https://image.eveonline.com/Type/30375_64.png\" /></div>");
              printf("<div class=\"clearfix\"></div>");
              printf("<h3 class=\"page-header\"> Salvage Materials <strong>(COMING SOON)</strong></h3>");
              printf("<div class=\"view view-first\"><img src=\"https://image.eveonline.com/Type/25605_64.png\" /></a> </div>");
              printf("<div class=\"view view-first\"><img src=\"https://image.eveonline.com/Type/30024_64.png\" /></div>");
