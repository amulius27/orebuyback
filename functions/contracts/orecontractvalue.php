...
//Get the last contract number
   ...
   $oreContents = array(
        ...
        'ContractTime' =>  $now,
        'QuoteTime' => $update,
        'Veldspar' => (integer)$post['Veldspar'],
        'Concentrated_Veldspar' => (integer)$post['Concentrated_Veldspar'],
        'Dense_Veldspar' => (integer)$post['Dense_Veldspar'],
        'Scordite' => (integer)$post['Scordite'],
        'Condensed_Scordite' => (integer)$post['Condensed_Scordite'],
        'Massive_Scordite' => (integer)$post['Massive_Scordite'],
        'Pyroxeres' => (integer)$post['Pyroxeres'],
        'Solid_Pyroxeres' => (integer)$post['Solid_Pyroxeres'],
        'Viscous_Pyroxeres' => (integer)$post['Viscous_Pyroxeres'],
        'Plagioclase' => (integer)$post['Plagioclase'],
        'Azure_Plagioclase' => (integer)$post['Azure_Plagioclase'],
        'Rich_Plagioclase' => (integer)$post['Rich_Plagioclase'],
        'Omber' => (integer)$post['Omber'],
        'Silvery_Omber' => (integer)$post['Silvery_Omber'],
        'Golden_Omber' => (integer)$post['Golden_Omber'],
        'Kernite' => (integer)$post['Kernite'],
        'Luminous_Kernite' => (integer)$post['Luminous_Kernite'],
        'Fiery_Kernite' => (integer)$post['Fiery_Kernite'],
        'Jaspet' => (integer)$post['Jaspet'],
        'Pure_Jaspet' => (integer)$post['Pure_Jaspet'],
        'Pristine_Jaspet' => (integer)$post['Pristine_Jaspet'],
        'Hemorphite' => (integer)$post['Hemorphite'],
        'Vivid_Hemorphite' => (integer)$post['Vivid_Hemorphite'],
        'Radiant_Hemorphite' => (integer)$post['Radiant_Hemorphite'],
        'Hedbergite' => (integer)$post['Hedbergite'],
        'Vitric_Hedbergite' => (integer)$post['Vitric_Hedbergite'],
        'Glazed_Hedbergite' => (integer)$post['Glazed_Hedbergite'],
        'Gneiss' => (integer)$post['Gneiss'],
        'Iridescent_Gneiss' => (integer)$post['Iridescent_Gneiss'],
        'Prismatic_Gneiss' => (integer)$post['Prismatic_Gneiss'],
        'Dark_Ochre' => (integer)$post['Dark_Ochre'],
        'Onyx_Ochre' => (integer)$post['Onyx_Ochre'],
        'Obsidian_Ochre' => (integer)$post['Obsidian_Ochre'],
        'Spodumain' => (integer)$post['Spodumain'],
        'Bright_Spodumain' => (integer)$post['Bright_Spodumain'],
        'Gleaming_Spodumain' => (integer)$post['Gleaming_Spodumain'],
        'Crokite' => (integer)$post['Crokite'],
        'Sharp_Crokite' => (integer)$post['Sharp_Crokite'],
        'Crystalline_Crokite' => (integer)$post['Crystalline_Crokite'],
        'Bistot' => (integer)$post['Bistot'],
        'Triclinic_Bistot' => (integer)$post['Triclinic_Bistot'],
        'Monoclinic_Bistot' => (integer)$post['Monoclinic_Bistot'],
        'Arkonor' => (integer)$post['Arkonor'],
        'Crimson_Arkonor' => (integer)$post['Crimson_Arkonor'],
        'Prime_Arkonor' => (integer)$post['Prime_Arkonor'],
        'Mercoxit' => (integer)$post['Mercoxit'],
        'Magma_Mercoxit' => (integer)$post['Magma_Mercoxit'],
        'Vitreous_Mercoxit' => (integer)$post['Vitreous_Mercoxit']
    );
