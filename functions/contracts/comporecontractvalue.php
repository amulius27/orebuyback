...
//Get the last contract number
    ...
    $compOreValue = array(
        ...
        "Compressed_Dark_Ochre" => $post["Compressed_Dark Ochre"] * ($Dark_Ochre * 100),
        "Compressed_Onyx_Ochre" => $post["Compressed_Onyx_Ochre"] * (($Dark_Ochre * 100) * 1.05),
        "Compressed_Obsidian_Ochre" => $post["Compressed_Obisidian_Ochre"] * (($Dark_Ochre * 100) * 1.10),
   ...
   $compOreContents = array(
        ...
        "ContractTime" =>  $now,
        "QuoteTime" => $update,
        "Compressed_Veldspar" => $post["Compressed_Veldspar"],
        "Compressed_Concentrated_Veldspar" => $post["Compressed_Concentrated_Veldspar"],
        "Compressed_Dense_Veldspar" => $post["Compressed_Dense_Veldspar"],
        "Compressed_Scordite" => $post["Compressed_Scordite"],
        "Compressed_Condensed_Scordite" => $post["Compressed_Condensed_Scordite"],
        "Compressed_Massive_Scordite" => $post["Compressed_Massive_Scordite"],
        "Compressed_Pyroxeres" => $post["Compressed_Pyroxeres"],
        "Compressed_Solid_Pyroxeres" => $post["Compressed_Solid_Pyroxeres"],
        "Compressed_Viscous_Pyroxers" => $post["Compressed_Viscous_Pyroxeres"],
        "Compressed_Plagioclase" => $post["Compressed_Plagioclase"],
        "Compressed_Azure_Plagioclase" => $post["Compressed_Azure_Plagioclase"],
        "Compressed_Rich_Plagioclase" => $post["Compressed_Rich_Plagioclase"],
        "Compressed_Omber" => $post["Compressed_Omber"],
        "Compressed_Silvery_Omber" => $post["Compressed_Silvery_Omber"],
        "Compressed_Golden_Omber" => $post["Compressed_Golden_Omber"],
        "Compressed_Kernite" => $post["Compressed_Kernite"],
        "Compressed_Luminous_Kernite" => $post["Compressed_Luminous_Kernite"],
        "Compressed_Fiery_Kernite" => $post["Compressed_Fiery_Kernite"],
        "Compressed_Jaspet" => $post["Compressed_Jaspet"],
        "Compressed_Pure_Jaspet" => $post["Compressed_Pure_Jaspet"],
        "Compressed_Pristine_Jaspet" => $post["Compressed_Pristine_Jaspet"],
        "Compressed_Hemorphite" => $post["Compressed_Hemorphite"],
        "Compressed_Vivid_Hemorphite" => $post["Compressed_Vivid_Hemorphite"],
        "Compressed_Radiant_Hemorphite" => $post["Compressed_Radiant_Hemorphite"],
        "Compressed_Hedbergite" => $post["Compressed_Hedbergite"],
        "Compressed_Vitric_Hedbergite" => $post["Compressed_Vitric_Hedbergite"],
        "Compressed_Glazed_Hedbergite" => $post["Compressed_Glazed_Hedbergite"],
        ...
        "Compressed_Obsidian_Ochre" => $post["Compressed_Obisidian_Ochre"],
        "Compressed_Spodumain" => $post["Compressed_Spodumain"],
        "Compressed_Bright_Spodumain" => $post["Compressed_Bright_Spodumain"],
        "Compressed_Gleaming_Spodumain" => $post["Compressed_Gleaming_Spodumain"],
        "Compressed_Crokite" => $post["Compressed_Crokite"],
        "Compressed_Sharp_Crokite" => $post["Compressed_Sharp_Crokite"],
        "Compressed_Crystalline_Crokite" => $post["Compressed_Crystalline_Crokite"],
        "Compressed_Bistot" => $post["Compressed_Bistot"],
        "Compressed_Triclinic_Bistot" => $post["Compressed_Triclinic_Bistot"],
        "Compressed_Monoclinic_Bistot" => $post["Compressed_Monoclinic_Bistot"],
        "Compressed_Arkonor" => $post["Compressed_Arkonor"],
        "Compressed_Crimson_Arkonor" => $post["Compressed_Crimson_Arkonor"],
