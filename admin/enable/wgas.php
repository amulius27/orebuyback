...
foreach($Items as $item) {
    $itemEnabled[$item["ItemId"]] = $db->fetchColumn('SELECT Enabled FROM WGasPrices WHERE ItemId= :item AND Time= :time', array('item' => $item["ItemId"], 'time' => $lastUpdate));
}
    ...
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading" align="center">
                <h3 class="panel-title"><span style="font-family: Arial; color: #FFF;"<strong>Enable Wormhole Gas Pricing Form</strong></span><br></h3>
            </div>
            <div class="panel-body" align="left">
                <?php
                    printf("<form class=\"form-horizontal\" action=\"/../processes/setenablewgas.php\" method=\"POST\">");
